...
I took the time to conduct multiple rounds of user testing to get early feedback on the gallery environment, the start and exit panels, movement from one booth to another, and testing the final product.
